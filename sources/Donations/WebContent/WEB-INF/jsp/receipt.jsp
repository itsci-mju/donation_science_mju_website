...
<table border="1" width="100%">
	...
	<tr>
		<td style ="float: right;" colspan="2">
			<form action="ReceiptDonationServlet" name="frm" method="post" id="frm" enctype="multipart/form-data">
				<input name="donationID" type="hidden" value="<%= donationID%>">
				<input name="projectID" type="hidden" value="<%= projectID%>">
				<input name="year" type="hidden" value="<%= year%>">
				<input name="project_detailID" type="hidden" value="<%= project_detailID%>">
